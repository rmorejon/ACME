...
namespace ACME.iOS.Renderers
{
    ...
    public class ExtendedEntryRenderer : EntryRenderer
    {
            ...
            if (!string.IsNullOrEmpty(element.Image))
                switch (element.ImageAlignment)
                {
                    case ImageAlignment.Left:
                        ...
                        textField.LeftView = this.GetImageView(element.Image, element.ImageHeight, element.ImageWidth);
                        break;
                    case ImageAlignment.Right:
                        textField.RightViewMode = UITextFieldViewMode.Always;
                        textField.RightView = this.GetImageView(element.Image, element.ImageHeight, element.ImageWidth);
                        break;
                }
        ...
        {
            var uiImageView =
                new UIImageView(UIImage.FromBundle(imagePath)) { Frame = new RectangleF(0, 0, width, height) };
